...
# Module originally called htkmfc.py
# Modified by Marie Roch, San Diego State University
...
class HTKFeat_read(object):
    ...
    def openhtk(self, filename):
        ...
        self.fh = builtins.open(filename, "rb")
        self.readheader()
    ...
    def getlen(self):
        "Returns number of feature vectors"
        return self.nSamples
    
    def getdim(self):
        "Returns dimension of feature vector"
        return self.veclen
...
class HTKFeat_write(object):
    ...
    def openhtk(self, filename):
        self.filename = filename
        self.fh = builtins.open(filename, "wb")
        self.writeheader()
